...
namespace eggs { namespace variants { namespace detail
{
    ...
    private:
        ...
        {
            char _target;
            _union<typename split<pack<Ts...>>::left, true> _left;
            _union<typename split<pack<Ts...>>::right, true> _right;
        };
    };
    ...
    private:
        ...
        {
            char _target;
            _union<typename split<pack<Ts...>>::left, false> _left;
            _union<typename split<pack<Ts...>>::right, false> _right;
        };
    };
